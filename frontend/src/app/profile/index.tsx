                    ...
                    <div className="info">
                        ...
                        {found && user.id == profile.id && <>
                            {user?.spotify && user?.spotify.trim().length > 0 ?
                                ...
                                : <a href={`https://accounts.spotify.com/authorize?response_type=code&client_id=b350e4fa566b4aa1be5315e2bf0d80e9&scope=user-read-currently-playing%20user-read-playback-state&redirect_uri=http://127.0.0.1:5173/spotify`}>
